...
async function createTestContact() {
  ...
  try {
      ...
      properties: {
        ...
        "Opmerkingen": {
          rich_text: [
            {
              text: {
                content: "Dit is een testcontact aangemaakt via het script. We zijn geïnteresseerd in advies over de WBSO-subsidie voor ons nieuwe AI-project. Graag contact opnemen voor verdere details."
              }
            }
          ]
        },
    ...
    if (error.code === 'validation_error') {
      console.error('\x1b[33mEr is een probleem met de velden. Controleer of alle veldnamen correct zijn in je Notion database.\x1b[0m');
