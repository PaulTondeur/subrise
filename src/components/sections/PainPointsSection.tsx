      ...
      <div className="container mx-auto px-4 md:px-6 relative">
        ...
        <div className="mt-16 max-w-3xl mx-auto text-center">
          <p className="text-gray-700 text-xl leading-relaxed italic">
            Dat is precies waarom we Subrise hebben ontwikkeld. Ons platform neemt de complexiteit
            weg, zodat jij je kunt focussen op waar het echt om draait: innovatie. Wij hebben als
            ondernemers al veel met de WBSO te maken gehad en weten daarom precies wat belangrijk is
            voor jou.
          </p>
        </div>
      </div>
